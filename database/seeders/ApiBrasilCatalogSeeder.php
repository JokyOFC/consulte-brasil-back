...
final class ApiBrasilCatalogSeeder extends Seeder
{
    ...
    private const CATALOG = [
        ...
        ['ab_cpf_spc_serasa', 'CPF — SPC Serasa', 'Restrições e score de crédito (Serasa).', 1.8,
        ...
        ['ab_cpf_serasa_premium', 'CPF — Serasa Premium', 'Relatório premium de crédito (Serasa, PF).', 36.3,
            ['endpoint' => 'dados/cpf/credits', 'group' => 'cpf', 'key' => 'cpf', 'tipo' => 'serasa-premium-pf', 'homolog' => true]],
        ['ab_cpf_serasa_score', 'CPF — Serasa Score', 'Score de crédito Serasa (PF).', 7.5,
        ...
        ['ab_cpf_limite', 'CPF — Crédito Define Limite', 'Definição de limite de crédito.', 10.79,
            ['endpoint' => 'dados/cpf/credits', 'group' => 'cpf', 'key' => 'cpf', 'tipo' => 'limite-pj', 'homolog' => true]],
        ['ab_cpf_limite_positivo', 'CPF — Limite Positivo', 'Definição de limite com cadastro positivo.', 12.39,
        ...
        ['ab_cnpj_serasa_premium', 'CNPJ — Serasa Premium', 'Relatório premium de crédito (Serasa, PJ).', 36.3,
