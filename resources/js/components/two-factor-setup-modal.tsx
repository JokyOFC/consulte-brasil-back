    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'A autenticação em dois fatores está ativa. Escaneie o QR code ou insira a chave no seu app autenticador.',
                buttonText: 'Fechar',
            };
        }
        ...
        return {
            ...
            description:
                'Para concluir a ativação, escaneie o QR code ou insira a chave no seu app autenticador',
            buttonText: 'Continuar',
        };
