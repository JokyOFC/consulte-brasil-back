        ...
        <>
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                <PageHeader
                    ...
                    description="Auditoria de todas as chamadas à API: corpo da requisição, status, latência e resposta."
                />
                            ...
                            <tbody>
                                {logs.data.map((log) => (
                                    <tr key={log.id} className="border-b border-border last:border-0 hover:bg-muted/40">
                                        ...
                                        <td className="px-4 py-3">{log.account_name ?? <span className="text-muted-foreground">—</span>}</td>
