...
{
    private const CODE = 'cpf_analise_credito_basic';
    ...
    public function up(): void
    {
        ...
        if (! DB::table('query_types')->where('code', self::CODE)->exists()) {
            DB::table('query_types')->insert([
                'id' => (string) Str::uuid(),
                'code' => self::CODE,
                'name' => 'CPF — Análise de crédito básica',
                'description' => 'Análise de crédito básica para pessoa física.',
        ...
        DB::table('provider_capabilities')->insert([
            ...
            'config' => json_encode([
                ...
                'body_key' => 'cpf',
                'device_group' => 'cpf',
                'body' => ['tipo' => 'analise-credito-basic-pf'],
                'homolog' => true,
            ]),
            'created_at' => now(),
            'updated_at' => now(),
